...
export interface PreCacheOption<T> {
  cacheKey?: string;
  enable: boolean
...
type fetchT = <T extends string | ArrayBuffer | WechatMiniprogram.IAnyObject>(option: fetchOption<T>, priority?: 'normal' | 'low') => Promise<WechatMiniprogram.RequestSuccessCallbackResult<T> & { requestConfig: fetchOption<T> }>
